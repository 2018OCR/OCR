...
def routing(vote,
    ...
    Args:
        ...
        regularizer:
                I dont't know what this is, but every Dalao's routing function has one!
                A (Tensor -> Tensor or None) function; the result of applying it on a newly created variable
